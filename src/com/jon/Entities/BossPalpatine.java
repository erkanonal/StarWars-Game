...
public class BossPalpatine extends GameObject implements EntityB{
	...
	public BossPalpatine(int x, int y)
	{
		super(x, y);
		...
		try 
		{
			imageFront = ImageIO.read(new File("res\\images\\palpatineFront.png"));
		} 
		catch (IOException e) 
		{
			e.printStackTrace();
